...
**已验证通过。** MCP runtime 已安装（ccfts-mcp 0.3.0, mcp 1.27.2），所有 6 个工具均通过 smoke test。

✅ MCP smoke test passed on: 2026-05-31
...
- 完整 MCP smoke test 需要安装 `mcp>=1.0.0` 和 MCP 客户端（如 Claude Desktop）
