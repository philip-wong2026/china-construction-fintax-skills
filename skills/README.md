...
| 等级 | 含义 | 当前状态 |
|------|------|---------|
| `research-verified` | 基于权威来源起草，待会计师审核 | **所有 96 个文件** |
| `accountant-verified` | 持证CPA审核并署名 | 暂无（待 CPA 审核） |

## 当前状态（2026-05-31）

**内部预览版（Internal Preview / Alpha）**：96 个技能文件，0 个验证问题，6 个职能领域全覆盖。面向懂施工企业财税业务的 AI agent 使用者，用于辅助检索、推理、工作流组织和检查，不作为最终合规意见。
